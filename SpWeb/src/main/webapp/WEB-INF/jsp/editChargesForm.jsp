...
<div class="form">
	<div id="tab" class="tab">
		<ul>
			<li><a href="#tabs-1"> Update Charges </a></li>
		...
		<div id="tabs-1" align="center">
			...
			<form:form method="post" action="editCharges.do"
				...
				<table>
					...
					<tr>
						...
						<td><c:choose>
								<c:when test="${chargesForm.subCharges}">
									<input type="checkbox" id="subCharges" name="subCharges"
					...
					<tr>
						<td colspan="2"><input type="submit" id="submit" value="Save"
							class="submit" /></td>
					</tr>
				</table>
			</form:form>
