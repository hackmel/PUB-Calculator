...
<div class="form">
    ...
    <div id="tab" class="tab">
        <ul>
            <li>
                <a href="#tabs-1" > Search Charges </a>
            </li>
                ...
                <table class="tbl">
                    ...
                    <c:forEach varStatus="status" items="${chargesList}" var="item">
                        ...
                        <c:choose>
                            ...
                            <td>
                                <a href="displayCharges.do?id=${item.id}">${item.description} </a> 
                            </td>
                        </tr>
                    </c:forEach>
                        ...
                        <tr>
                            <c:if test="${firstPage==false}" >
                                <th>
                                    ...
                                    <a href="${pageContext.request.contextPath}/paginateChargesList.do?page=previous" name="previous" class="button">Previous</a>
                            ...
                            <c:if test="${lastPage==false}" >
                                <th>
                                    ...
                                    <a href="${pageContext.request.contextPath}/paginateChargesList.do?page=next" name="next" class="button">Next</a>
