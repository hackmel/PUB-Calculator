                ...
                <form:form method="post"  modelAttribute="tenantForm">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><c:choose>
                                    <c:when test="${tenantForm.visitor}">
                                        <input type="checkbox" name="visitor" id="visitor"  checked="checked" class="text_box"/>
                                    </c:when>

                                    <c:otherwise>
                                        <input type="checkbox" name="visitor" id="visitor"  class="text_box"/>
                                    </c:otherwise>    
                                </c:choose> </td> 
                            <td><span></span></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><form:select id="visitorOf" path="visitorOf" cssClass="text_box">
