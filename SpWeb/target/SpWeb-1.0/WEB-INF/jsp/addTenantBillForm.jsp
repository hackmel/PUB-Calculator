...
<div id="tab" class="tab">
	<ul>
		<li><a href="#tabs-1"> Select Tenant </a></li>
	...
	<div id="tabs-1" align="center">
		...
		<div>&nbsp;</div>
		<div>&nbsp;</div>
		<form:form action="processTenant.do"
			modelAttribute="tenantBillDurationForm" method="POST">
			...
			<div>
				<table>
					<tr>
						...
						<td align="right">Select Tenant:</td>
						<td><form:select path="tenantId"
								onchange="displayDuration();">
								<form:option value="NONE" label="--- Select ---" />
								<form:options items="${tenantList}" itemValue="id"
									itemLabel="firstName" />
							</form:select></td>
					...
					<tr>
						<td align="right">Manual entry of Charges:</td>
						<td>&nbsp;</td>
					</tr>

					<tr>
						<td>&nbsp;</td>
						<td><form:input path="charges" id="charges"/></td>
					</tr>
			...
			<table class="tbl" id="selectDate" name="selectDate">
				...
				<c:forEach varStatus="status" items="${dateList}" var="item">
					...
					<td><fmt:formatDate pattern="dd-MMM-yyyy" value="${item.date}" /></td>
			...
			<div>
				<input type="submit" name="back" value="Back" class="submit" /> <input
					type="submit" name="add" value="Add Tenant" class="submit" />
			</div>
		</form:form>
